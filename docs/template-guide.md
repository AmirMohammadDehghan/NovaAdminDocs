...
- تزریق CSS variables دیتابیسی با `{% raw %}{% nova_theme_css %}{% endraw %}`.
- تزریق config JS با `{% raw %}{% nova_theme_config %}{% endraw %}`.
...
```django
{% raw %}{% dashboard_report_data dashboard_list as dashboard_report %}{% endraw %}
```
...
```django
{% raw %}{% search_form cl %}{% endraw %}
{% raw %}{% admin_actions %}{% endraw %}
{% raw %}{% change_list_object_tools %}{% endraw %}
{% raw %}{% result_list cl %}{% endraw %}
{% raw %}{% pagination cl %}{% endraw %}
```
